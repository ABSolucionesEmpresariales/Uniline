...
<div class="container">
    <div class="contenedor-registro">
        ...
        <div class="tab-content" >
            ...
            <div id="menu1" class="tab-pane fade"><!-- REGISTRO DE CURSOS -->
            ...
            <div id="menu2" class="tab-pane fade"><!-- REGISTRO DE BLOQUES -->
            ...
            <div id="menu3" class="tab-pane fade"><!-- REGISTRO DE TEMAS -->
            ...
            <div id="menu4" class="tab-pane fade"><!-- REGISTRO DE EXAMENES -->
            ...
            <div id="menu5" class="tab-pane fade"><!-- REGISTRO DE TAREAS -->
