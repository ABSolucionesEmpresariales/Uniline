                                            ...
                                            <div class="card-text mt-3 text-center">
                                                <div>
                                                    ...
                                                    <div class="row justify-content-between" style="margin:2rem 0rem;">
                                                        <button type="button" value="${datos[i][0]}" class="item-comprar col-7 btn boton-compra text-center hover-boton compras" data-dismiss="modal" style=" background-color: #fd5601; color: white;">
                                                            COMPRAR
                                                        </button>  
                                                        <div class="col-4 div-precio d-flex flex-column align-items-center justify-content-center" style="background-color: #373d3d;" >
