...
<body style="
 ...
 <header id="header">
          ...
          <nav id="nav-menu-container">
            <ul class="nav-menu">
              ...
              ?>
                ...
                <li class="mt-3"><a class="text-center" href="canjeos.php" style="font-size: 14px; text-decoration: none;">Canjear cupon</a></li>
  ...
  <!-- Popular -->
    ...
    <div class="popular page_section" style="min-height: 40rem;">
        <div class="container fullscreen flex align-items-center justify-content-center">
            <div class="align-items-center justify-content-center bg-light alertaspago ">
                <div class="p-5">
                    <form class="form-group" id="FCupones">
                        <p class="text-center h2 m-5">Canjear Codigo</p>
                        <div class="m-2">
                            <p class="h4">Coloca el codigo:</p>
                            <input name="INCodigo" class="form-control" type="text" placeholder="Codigo" id="codigo">
                        </div>
                        <div class="m-2">
                            <p class="h4">Elije el curso:</p>
                        ...
                        <div class="m-5">
                            <button class="btn btn-success btn-block"  type="submit">Canjear codigo</button>
                        </div>
                    </form>
                </div>
            </div>
  ...
  <script src="../js/canjeos.js"></script>
